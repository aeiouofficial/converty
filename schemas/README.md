...
Path-bearing schemas also reject embedded NUL. The C# `FileConvert.Serialization` adapter adds an additional parser-hardening layer by rejecting duplicate JSON member names recursively before domain mapping.
