...
{
    [Fact]
    public void ConversionRequestRoundTripsWithExplicitWireAction()
    {
    ...
    [Fact]
    public void ConversionPresetRoundTripsAndSerializesOptionsInOrdinalKeyOrder()
    {
    ...
    [Fact]
    public void CapabilityDescriptorRoundTripsWithSchemaVersion()
    {
    ...
    [Fact]
    public void FormatDescriptorRoundTripsWithNormalizedExtensions()
    {
    ...
    [Fact]
    public void ConversionPlanRoundTripsNestedProbeWithoutExecutableConfiguration()
    {
    ...
    [Fact]
    public void JobStatusSnapshotRoundTripsStateProgressAndMessage()
    {
