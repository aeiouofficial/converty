...
- `FileConvert.Contracts.Tests`: managed contract/identifier validation plus seeded identifier properties.
- `FileConvert.Core.Tests`: managed registry/capability/planner/output/fake-provider tests plus seeded capability/output properties.
- `FileConvert.Serialization.Tests`: managed strict JSON round-trip and adversarial parsing tests.
